...
export type DragEntitiesActionType = 'DRAG_ENTITY_IN_SIDEBAR' | 'DRAG_ENTITY_IN_WORKSPACE' | 'DRAG_ENTITY_FROM_SIDEBAR_TO_WORKSPACE' | 'DRAG_ENTITY_FROM_WORKSPACE_TO_SIDEBAR';
